...
AVpath = './predict/predictions2.npy'
AVdata = np.load(AVpath)

lpath = 'predict_local.npy'
ldata = np.load(lpath)

gpath = 'predict_global.npy'
gdata = np.load(gpath)
...
mu = 0.01 * AVdata[:,2].reshape(101,101)**2
...
xl = ldata[:,0].reshape(101, 101)
rhol = ldata[:,2].reshape(101, 101)

xg = gdata[:,0].reshape(101, 101)
rhog = gdata[:,2].reshape(101, 101)
...
ax.plot(xg[:, 0], rhog[:, 51], label='PINN(Global)', marker='o',markevery=2, markersize=4, color='brown', linewidth=1.5)
ax.plot(xl[:, 0], rhol[:, 51], label='PINN(L-NN1)', marker='o',markevery=2, markersize=4, color='blueviolet', linewidth=1.5)
ax.plot(x[:, 0], rho[:, 51], label='PINN(L-NN2)', marker='o',markevery=2, markersize=4, color='red', linewidth=1.5)
...
zm1.plot(X51, Y51, marker='o', markersize=4, markevery=1,color='brown', linewidth=1.5)
zm1.plot(X41, Y41, marker='o', markersize=4, markevery=1,color='blueviolet', linewidth=1.5)
...
zm2.plot(X52, Y52, marker='o', markersize=4, markevery=1,color='brown', linewidth=1.5)
zm2.plot(X42, Y42, marker='o', markersize=4, markevery=1,color='blueviolet', linewidth=1.5)
...
zm3.plot(X53, Y53, marker='o', markersize=4, markevery=1,color='brown', linewidth=1.5)
zm3.plot(X43, Y43, marker='o', markersize=4, markevery=1,color='blueviolet', linewidth=1.5)
