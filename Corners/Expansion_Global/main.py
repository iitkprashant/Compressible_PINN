...
ns = EulerViscous2D(model, device=device, value=-5.0)
...
def train(epochs=10000, lr = 0.001):
    ...
    for epoch in range(epochs):
        ...
        dataloader_ = DataLoader(dataset=dataset, batch_size=6000, shuffle=True, pin_memory=True)
        for residuals in dataloader_:
            ...
            mse_base = loss.LossInlet(base, inlet_condition)
